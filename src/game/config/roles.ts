...
export const ROLES: RoleConfig[] = [
  ...
  },
  {
    ...
    automation: "partial",
    note: "已实现：每轮行动阶段开始前询问；成功后标记目标强制房间，目标轮到行动时锁定；限次、每人限 1 次、结算 +1 生命。5 步可达性固定按普通移动距离校验。",
  },
  {
    id: "hacker",
    name: "黑客",
  ...
  },
  {
    id: "prophet",
    name: "预言家",
    skill: "移动阶段可秘密做死亡预告（人数不限）。被预告者本轮变暗影时你得 2 点自由基因（公开分配）并恢复 1 点生命。整局限 6 次。",
    maxUses: 6,
    active: true,
    actionHint: "秘密对若干玩家做死亡预告",
    automation: "partial",
    note: "已实现：死亡预告标记、被预告者本轮变暗影 → 预言家 +1 生命并获得 2 点待分配基因。基因点的公开分配由玩家在面板分配。",
  },
  {
    id: "carrier",
    name: "病毒携带者",
  ...
  },
  {
    ...
    automation: "partial",
    note: "已实现：结算确认阶段选择是否赠予；按单张道具赠出、每人限 1 次；被赠予者在面板自行选择转移 1 点基因。",
  },
  {
    id: "chemist",
    name: "化学家",
